<div class=" d-flex flex-column mb-2">
    ...
    <div class="menu">
        <ul class="menu px-0">
            ...
            <li><a class="<?php if($finalDescription == ROOT.'/home'){ echo ' active"';}?>" href="<?=ROOT?>/home"><i class="icon-nav" data-feather="user"></i>Dashboard</a></li>

            <?php if(Auth::access('admin')):?>
            <li><a class="<?php if($finalDescription == ROOT.'/users'){ echo ' active"';}?>" href="<?=ROOT?>/users"><i class="icon-nav" data-feather="user"></i>Medewerkers</a></li>
            <?php endif; ?>
            <li class="dropdown-btn"><a class=" <?php if($finalDescription == ROOT.'/leden' || $finalDescription == ROOT.'/leden/inactive'){ echo ' active"';}?>" href="#"><i class="icon-nav" data-feather="user"></i>Leden<i style="margin-left: 120px" class="icon-nav" data-feather="chevron-down"></i></a></li>
            ...
            <li><a class="<?php if($finalDescription == ROOT.'/teams'|| $finalDescription == ROOT.'/beheer' ){ echo ' active"';}?>" href="<?=ROOT?>/teams"><i class="icon-nav" data-feather="users"></i>Teams</a></li>
            <li class="dropdown-btn"><a class=" <?php if($finalDescription == ROOT.'/klanten' || $finalDescription == ROOT.'/klanten/inactive'){ echo ' active"';}?>" href="#"><i class="icon-nav" data-feather="user"></i>Klanten<i style="margin-left: 105px" class="icon-nav" data-feather="chevron-down"></i></a></li>
