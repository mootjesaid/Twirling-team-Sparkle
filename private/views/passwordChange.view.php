                    ...
                    <h3>Wachtwoord herstellen</h3>
                            <form method="post" action="" name="update">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password"  name="pass1" value="" placeholder="Wachtwoord" class="form-control"/>
                                </div>


                                    <label>Herhaal nieuw wachtwoord</label>
                                    <input type="password"  name="pass2" value="" placeholder="Wachtwoord" class="form-control"/>
                                <input type="hidden" name="email" value="<?php echo $email; ?>"/>
                                <br>
                                <div class="form-group">
                                    <input style="width: 100px" type="submit" id="reset" value="Herstel"  class=" btn btn-primary"/>
                                </div>
